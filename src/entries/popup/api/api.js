const API_BASE = "https://tacomail.de/api/v1";
...
export function getAttachmentDownloadUrl(address, emailId, attachmentId) {
    return `${API_BASE}/mail/${address}/${emailId}/attachments/${attachmentId}`;
}

export function getRawMailUrl(address, emailId) {
    return `${API_BASE}/mail/${address}/${emailId}`
}